...
export default class Body extends React.Component {
    render() {
        return (
            <React.Fragment>
                <Helmet>
                    <title>{_.get(this.props, 'pageContext.frontmatter.seo.title', "") ? (_.get(this.props, 'pageContext.frontmatter.seo.title', "")) : _.get(this.props, 'pageContext.frontmatter.title', "") + ' | ' + _.get(this.props, 'pageContext.site.siteMetadata.title', "")}</title>
                    <meta charSet="utf-8"/>
